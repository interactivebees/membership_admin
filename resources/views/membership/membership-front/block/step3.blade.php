<div class="members-section" id="organization-head">
    <div class="inner-box" id="">
        <h4 class="membership-heading">Organization Head</h4>
        <ul class="full-form">
            <li>
            ...
            <li>
                <div class="input-group">
                    ...
                    <input type="tel" name="oh_mobile_no" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minlength="10" maxlength="10"
                        value="{{ old('oh_mobile_no') }}"
                        class="@error('oh_mobile_no') is-invalid @enderror dynamic-input">
                </div>
            </li>
            <li>
                <div class="input-group">
            ...
            <li>
                <div class="input-group">
                    ...
                    <input type="tel" name="oh_whatsApp_contact_no" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minlength="10" maxlength="10"
                        value="{{ old('oh_whatsApp_contact_no') }}"
                        class="@error('oh_whatsApp_contact_no') is-invalid @enderror dynamic-input" required>
                </div>
            </li>
        </ul>
    </div>
