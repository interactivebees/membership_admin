...
<body>
    <table cellspacing="0" cellpadding="0" width="700px" align="center" bgcolor="#F1F7FF">
         <tr>
            <td align="center"><img src="https://www.caho.in/images/cahocon-banners-video.jpg" width="100%"></td>
        </tr>
        <tr>
            <td height="20px"></td>
        </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 20px;color: #000;font-weight: 600;font-family: Arial, Helvetica, sans-serif;">{{ $data['data']['video_title'] ?? "" }}</td>
                                </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>    
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-size: 18px;color: #fff;font-weight: 500;font-family: Arial, Helvetica, sans-serif;background:#90974a;padding: 4px 7px;">Video Details</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <table cellspacing="0" cellpadding="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    <td width="40%" style="font-size: 14px;font-weight: 600;font-family: Arial, Helvetica, sans-serif;">Link:
                                                                        </td>
