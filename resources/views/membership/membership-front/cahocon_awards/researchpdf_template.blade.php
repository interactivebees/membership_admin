...
<body>
    <table cellspacing="0" cellpadding="0" width="700px" align="center" bgcolor="#F1F7FF">
        <tr>
            <td align="center"><img src="https://www.caho.in/images/research-publication-banner.jpg" width="100%"></td>
        </tr>
        <tr>
            <td height="20px"></td>
        </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 20px;color: #000;font-weight: 600;font-family: Arial, Helvetica, sans-serif;"><span style="color:#000;">{{ $data['data']['video_title'] ?? "" }}</span></td>
                                </tr>
                                <tr>
                                    <td height="20px"></td>
                                </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>    
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-size: 18px;color: #fff;font-weight: 500;font-family: Arial, Helvetica, sans-serif;background:#90974a;padding: 4px 7px;">Research Publication Details</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <table cellspacing="0" cellpadding="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    <td width="40%" style="font-size: 14px;font-weight: 600;font-family: Arial, Helvetica, sans-serif;">Title:</td>
                                                                ...
                                                                <tr>
                                                                    <td width="40%" style="font-size: 14px;font-weight: 600;font-family: Arial, Helvetica, sans-serif;"><span style="color: #000;font-weight:400;">{{ $data['data']['video_title'] ?? "" }}</span></td>
                                                                ...
                                                                <tr>
                                                                    <td width="40%" style="font-size: 14px;font-weight: 600;font-family: Arial, Helvetica, sans-serif;">Introduction / Background : </td>
                                                                ...
                                                                <tr>
                                                                    <td width="40%" style="font-size: 14px;font-weight: 600;font-family: Arial, Helvetica, sans-serif;"><span style="color: #000;font-weight:400;">{{ $data['data']['video_introduction'] ?? "" }}</span></td>
                                                                ...
                                                                <tr>
                                                                    <td width="40%" style="font-size: 14px;font-weight: 600;font-family: Arial, Helvetica, sans-serif;">Please provide the link to the publication in the Journal:
                                                                       </td>
                                                                ...
                                                                <tr>
                                                                    <td width="40%" style="font-size: 14px;font-weight: 600;font-family: Arial, Helvetica, sans-serif;">
                                                                        <span style="color: #000;font-weight:400;">{{ $data['data']['video_link'] ?? "" }}</span></td>
                                                                ...
                                                                <tr>
                                                                    <td width="40%" style="font-size: 14px;font-weight: 600;font-family: Arial, Helvetica, sans-serif;">Uploaded Document:<span style="color: #000;font-weight:400;"><a href="https://caho.in/{{ ($data['data']['upload_your_document'] ?? "") }}" style="color: #90974a;text-decoration: none;">View </a></span></td>
