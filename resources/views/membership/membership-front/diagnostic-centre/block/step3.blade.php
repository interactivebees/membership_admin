<div class="members-section" id="contact-person1">
    <div class="inner-box" id="">
        <h4 class="membership-heading">Contact Person Representing Diagnostic Centre </h4>
        <ul class="full-form">
            <li>
            ...
            <li>
                <div class="input-group">
                    ...
                    <input type="text" name="one_mobile_no"
                        value="{{ old('one_mobile_no') }}"
                        class="@error('one_mobile_no') is-invalid @enderror">
                </div>
            </li>
            <li>
                <div class="input-group">
            ...
            <li>
                <div class="input-group">
                    ...
                    <input type="text" name="one_whatsApp_contact_no"
                        value="{{ old('one_whatsApp_contact_no') }}"
                        class="@error('one_whatsApp_contact_no') is-invalid @enderror" required>
                </div>
            </li>
        </ul>
    </div>
    <ul class="full-form">
        <li class="text-left">
            <button type="button" class="btn-submit" id="back-step-2">Back</button>
        </li>
        <li class="text-right">
